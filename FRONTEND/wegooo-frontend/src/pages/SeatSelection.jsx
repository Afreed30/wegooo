...
const SeatSelection = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      const res = await fetch("http://127.0.0.1:8000/api/book_seats/payment/", {
        method: "POST",
      ...
      const options = {
        key: "rzp_test_Rc9a1tetxWiY2z", // Test Key
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M16.8,15H19a1,1,0,0,1,1,1.16l-.53,3.17a2,2,0,0,1-2,1.67h-11a2,2,0,0,1-2-1.67L4,16.16A1,1,0,0,1,5,15H7.38a1,1,0,0,1,.9.55A2.61,2.61,0,0,0,10.62,17h2.94a2.61,2.61,0,0,0,2.34-1.45A1,1,0,0,1,16.8,15Z"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                      />
                    </svg>
